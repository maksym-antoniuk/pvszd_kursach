...
CREATE TABLE `cars` (
  ...
  `status` enum('fixed','broken','non_active') NOT NULL DEFAULT 'fixed',
  `description` text,
  `is_fixed` int(11) NOT NULL DEFAULT '1',
  `model` varchar(45) DEFAULT NULL,
  `current_position` varchar(30) NOT NULL DEFAULT '50.018765,36.2276296',
