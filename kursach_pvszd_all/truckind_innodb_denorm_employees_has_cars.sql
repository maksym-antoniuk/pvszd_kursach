...
CREATE TABLE `employees_has_cars` (
  ...
  CONSTRAINT `fk_employees_has_cars_cars1` FOREIGN KEY (`cars_id`) REFERENCES `cars` (`id`),
  CONSTRAINT `fk_employees_has_cars_employees1` FOREIGN KEY (`employees_id`) REFERENCES `employees` (`id`)
