...
CREATE TABLE `journeys` (
  ...
  CONSTRAINT `fk_journeys_contracts1` FOREIGN KEY (`contracts_id`) REFERENCES `contracts` (`id`),
  CONSTRAINT `fk_journeys_employees1` FOREIGN KEY (`creator_id`) REFERENCES `employees` (`id`),
  CONSTRAINT `fk_journeys_employees2` FOREIGN KEY (`driver_id`) REFERENCES `employees` (`id`)
...
-- Dump completed on 2018-06-14 13:27:17
